...
Additional language-specific SCIP producers beyond Rust and Go remain deferred.
The proposed explicit Rust and Go producer/import CLIs in ADR-0052 and ADR-0053
are not automatic indexing, MCP operations, or a general compiler-execution
framework.
