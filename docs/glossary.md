...
implements the read-only `architecture_map`, `architecture_overview`, `repository_topology`, `code_graph_query`, `context_build`, `phase2_context_build`, `code_search`, `locate_relevant_paths`, `symbol_search`, `diagnostics`,
