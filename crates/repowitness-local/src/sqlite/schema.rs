...
pub(super) const MIGRATION_1_NAME: &str = "phase0_immutable_generations";
pub(super) const MIGRATION_2_NAME: &str = "bounded_search_projection_rebuild";
pub(super) const MIGRATION_3_NAME: &str = "artifact_payload_integrity";
...
ADD COLUMN payload_digest BLOB
