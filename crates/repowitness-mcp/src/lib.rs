...
pub use server::{
    DEFAULT_MCP_OPERATION_CONCURRENCY, MAX_MCP_REGISTERED_REPOSITORIES, McpRepositoryCatalog,
    McpRepositoryCatalogLoader, McpRepositoryRegistryError, McpServeError, RepoWitnessMcpServer,
    serve_stdio, serve_stdio_with_memory_writes, serve_stdio_with_reloadable_repository_catalog,
...
pub use wire::{
    ...
    MemoryRecallServiceSelection, OUTBOUND_SITES_TOOL_NAME, OutboundSitesInput,
    ...
    SCIP_EVIDENCE_SCHEMA_VERSION, SCIP_EVIDENCE_TOOL_NAME, SCIP_RELATIONSHIP_TRACE_SCHEMA_VERSION,
    SCIP_RELATIONSHIP_TRACE_TOOL_NAME, SCIP_SYMBOL_RESOLVE_TOOL_NAME, SYMBOL_GET_TOOL_NAME,
